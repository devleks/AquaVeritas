...
.stTabs [aria-selected="true"] {
    ...
    border-bottom-color: #00A1E0 !important;
}
...
.stButton > button:disabled { background-color: #D8DDE6 !important; color: #706E6B !important; }
...
[data-testid="stAlert"] { border-radius: 4px; font-size: 0.875rem; }
